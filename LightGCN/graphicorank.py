...
class Amz_Dataset():
    def load(self, metadata=False):
        ...
        Returns:
            ...
            ``user_id``, ``movie_id`` and ``rating`` (a label from 1 to 5).
        """
        rating_file = "/home/ubuntu/tests/graphranko/LightGCN/Data/amazon-electronics-v4/user-item-rating.csv"
        user_file = "/home/ubuntu/tests/graphranko/LightGCN/Data/amazon-electronics-v4/user_list.txt"
        item_file = "/home/ubuntu/tests/graphranko/LightGCN/Data/amazon-electronics-v4/item_meta_list.txt"
        category_file = "/home/ubuntu/tests/graphranko/LightGCN/Data/amazon-electronics-v4/categories.txt"
